    ...
    return `
        ...
        <body style="margin:0; padding:0; background:#f3f4f6; color:#111111;">
            <div class="container">
                <div class="header">
                    ${embeddedLogoSrc
            ? `<img src="${embeddedLogoSrc}" alt="LOST." style="width:72px; height:72px; object-fit:contain; display:block; margin:0 auto 14px auto;" />`
            : ""}
                ...
                <div class="footer">
                    ...
                    <a href="https://thelostlabel.com">thelostlabel.com</a>
                </div>
            </div>
        </body>
        </html>
...
export function generateVerificationEmail(verificationLink) {
    return renderAuthEmail({
        ...
        body: `<p class="text">Welcome to LOST. Please verify your email address to activate your account and continue to the dashboard.</p>`,
...
export function generateAccountApprovalEmail(loginLink, verificationLink = null) {
    if (verificationLink) {
        return renderAuthEmail({
            ...
            body: `<p class="text">Your application to join LOST. has been approved. Before you sign in, please complete email verification.</p>`,
    ...
    return renderAuthEmail({
        ...
        body: `<p class="text">Your application to join LOST. has been approved. You can now sign in and access your dashboard.</p>`,
        ctaLabel: "Sign In",
        ctaLink: loginLink,
    });
}
        ...
        <body>
            <div class="container">
                ...
                <div class="card">
                    ...
                    <a href="https://thelostlabel.com/dashboard?view=my-earnings" class="button">VIEW PAYOUTS</a>
                </div>
                <div class="footer">
                    &copy; ${new Date().getFullYear()} THE LOST LABEL. ALL RIGHTS RESERVED.<br/>
                    <a href="https://thelostlabel.com">WWW.THELOSTLABEL.COM</a>
