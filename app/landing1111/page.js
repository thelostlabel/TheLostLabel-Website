...
const stackCards = [
  { title: "TRAP AFTER DEATH", year: "2020", tone: "paper" },
  { title: "TRAPSTAR", year: "2018", tone: "blue" },
  { title: "VOID CLUB", year: "2023", tone: "sand" },
];
...
export default function Landing1111Page() {
          ...
          <div className={styles.cardScene}>
            <div className={styles.cardDeck} ref={cardDeckRef}>
              <article
                ...
                ref={stackBackRef}
              >
                <div className={styles.ghostCardHead}>
                  <h3 className={`${styles.ghostTitle} ${headline.className}`}>{stackCards[0].title}</h3>
                  <p className={`${styles.ghostYear} ${headline.className}`}>{stackCards[0].year}</p>
                </div>
              </article>
              ...
              >
                <div className={styles.ghostCardHead}>
                  <h3 className={`${styles.ghostTitle} ${headline.className}`}>{stackCards[1].title}</h3>
                  <p className={`${styles.ghostYear} ${headline.className}`}>{stackCards[1].year}</p>
                </div>
              </article>
              ...
              >
                <div className={styles.ghostCardHead}>
                  <h3 className={`${styles.ghostTitle} ${headline.className}`}>{stackCards[2].title}</h3>
                  <p className={`${styles.ghostYear} ${headline.className}`}>{stackCards[2].year}</p>
                </div>
              </article>
