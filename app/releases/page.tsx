...
function getSeoLabelName(publicSettings: PublicSettings | null): string {
...
function getCatalogDescription(labelName: string): string {
...
function getCatalogPath(page: number): string {
  return page > 1 ? `/releases?page=${page}` : "/releases";
}

function getReleaseHref(release: { name: string; artist: string; id: string }): string {
