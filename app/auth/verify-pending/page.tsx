...
function VerifyPendingContent(): React.ReactElement {
    ...
    const handleResend = async (): Promise<void> => {
        ...
        } catch (error: unknown) { setError("Failed to send email. Please check your connection."); }
    ...
    const handleUpdateEmail = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
        ...
        } catch (error: unknown) { setError("Failed to update email."); }
        finally { setLoading(false); }
    };
                        ...
                        <div style={{
                            ...
                            <AnimatePresence mode="wait">
                                {!isEditing ? (
                                    ...
                                    >
                                        <input type="email" value={newEmail} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setNewEmail(e.target.value)} required placeholder="New email"
...
export default function VerifyPending(): React.ReactElement {
    return (
