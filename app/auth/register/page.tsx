...
export default function Register(): React.ReactElement {
    const [formData, setFormData] = useState<RegisterFormData>({ fullName: '', stageName: '', email: '', password: '' });
                ...
                <form onSubmit={handleRegister} className="ca-form">
                    ...
                    <div className="ca-two-col">
                        <div className="ca-field">
                            ...
                            <input type="text" placeholder="John Doe" value={formData.fullName} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, fullName: e.target.value })} required />
                        </div>
                        <div className="ca-field">
                            <label>STAGE NAME</label>
                            <input type="text" placeholder="Phantom" value={formData.stageName} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, stageName: e.target.value })} required />
                    ...
                    <div className="ca-field">
                        ...
                        <input type="email" placeholder="artist@example.com" value={formData.email} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, email: e.target.value })} required />
                    </div>

                    <div className="ca-field">
                        <label>PASSWORD</label>
                        <input type="password" placeholder="Minimum 8 characters" value={formData.password} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, password: e.target.value })} required />
                    </div>
