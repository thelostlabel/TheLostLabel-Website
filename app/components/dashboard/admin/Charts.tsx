...
export const GoalProgress = ({ label, current, target, color }: GoalProgressProps) => {
...
export const ChartTooltip = ({ active, payload, label, color }: any) => {
...
export const RechartsAreaChart = ({ data, color = '#8b5cf6', height = 260 }: RechartsAreaChartProps) => {
                            ...
                            content={({ active, payload }: any) => {
                                ...
                                return (
                                    <div style={{
                                        ...
                                        <div style={{ fontSize: '12px', fontWeight: '900', color: (payload[0].payload as DonutDataItem).color }}>
                                            ${Number(payload[0].value).toLocaleString()} ({total ? Math.round((Number(payload[0].value) / total) * 100) : 0}%)
                                        </div>
                                    </div>
                                );
                            }}
...
export function pickPlatformColor(label: string): string {
