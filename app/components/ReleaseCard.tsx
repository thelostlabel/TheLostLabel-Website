...
interface ReleaseCardProps {
    ...
    initialData?: ReleaseData & { versionCount?: number };
}

export default function ReleaseCard({ id, fallbackTitle, fallbackArtist, initialData }: ReleaseCardProps) {
    ...
    const getBaseTitle = (t: string | undefined) => {
        if (!t) return "";
