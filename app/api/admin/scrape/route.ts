...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        let apiStats: { followers: number; popularity: number; imageUrl: string | undefined; name: string } | null = null;
        if (spotifyId) {
        ...
        if (artistId || spotifyId) {
            try {
                ...
                try {
                    ...
                    console.log(`[API Scrape] Fallback update failed:`, error instanceof Error ? error.message : "Unknown error");
                }
            }
            ...
            if (updatedArtist) {
                try {
                    ...
                    console.error("[API Scrape] History creation failed:", error instanceof Error ? error.message : "Unknown error");
                }
            }
        }
