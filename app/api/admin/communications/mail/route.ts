...
export async function POST(req: NextRequest): Promise<Response> {
    ...
    try {
        const { subject, html, recipientIds, sendToAll, includeSender = true } = await req.json() as {
            subject: string;
            html: string;
            recipientIds?: string[];
            sendToAll?: boolean;
        ...
        let recipients: Array<{ email?: string | null; name?: string | null; user?: { email: string | null; stageName?: string | null; fullName?: string | null } | null }> = [];
        let userRecipients: Array<{ email: string | null; stageName: string | null; fullName: string | null }> = [];
        ...
        const targetList: Recipient[] = recipients
            .map((a) => ({
        ...
        const uniqueTargets: Recipient[] = Array.from(
