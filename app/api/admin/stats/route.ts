        ...
        const payload = await getCachedAdminStats(async () => {
            ...
            const [
                ...
                prisma.$queryRaw`
                    ...
                    ORDER BY label ASC
                    LIMIT 12
                ` as Promise<Array<{ label: string; revenue: unknown; artistShare: unknown }>>,
                ...
                prisma.$queryRaw`
                    ...
                    ORDER BY label ASC
                    LIMIT 12
                ` as Promise<Array<{ label: string; amount: unknown }>>,
                prisma.$queryRaw`
                    ...
                    ORDER BY label ASC
                    LIMIT 365
                ` as Promise<Array<{ label: string; value: unknown }>>,
