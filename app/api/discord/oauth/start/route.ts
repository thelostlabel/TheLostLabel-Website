...
function buildDashboardRedirect(baseUrl: string, code: string): URL {
...
function buildLoginRedirect(baseUrl: string, callbackPath: string): URL {
...
export async function GET(req: NextRequest): Promise<Response> {
    ...
    authorizeUrl.searchParams.set("client_id", bridgeConfig.oauthClientId as string);
    authorizeUrl.searchParams.set("redirect_uri", bridgeConfig.oauthRedirectUri as string);
